...
Invoke split_components & split_patterns for subtable with Cohort=="CDR=0,amy-", etc., and AcqDuration==0 for cross-sectional analyses,
...
Form y\* and Y for cross-sectional or longitudinal analyses. soto is a sub-tibble generated by function
split_patterns().
...
Number of thin-plate spline knots needs a degree of freedom for model intercept, a constant basis always required. See
also <https://stats.stackexchange.com/questions/359568/choosing-k-in-mgcvs-gam>.
...
Above, inferences used Components_*.

Below, inferences will preferentially use Pattern_*.
...
Cross-sectional data, set by chunk "Form y\* and Y" Analog of Fig. 2D, Nazeri et al. Neuron 2022. {Age -\>
Component_i}\_i for CN, preclinical, MCI, AD, atypical
...
ggsave(sprintf("Patterns %i-%i vs Age and Dx, no atypicals.png", ipatt0, ipattF), width=12, height=18, units="in", scale=3, dpi=600, limitsize=FALSE)
...
Mixed models for longitudinal data, set by chunk "Form y\* and Y" Analog of Fig. 2D, Nazeri et al. Neuron 2022. {Age -\>
Component_i}\_i

...
for (i in 1:N) {
  ...
  mkdir(paste0("baseline_cn_repA", i))
  mkdir(paste0("baseline_cn_repB", i))
  write.table(repA, paste0("baseline_cn_repA", i, "/nifti_files.csv"), row.names = F, col.names = F, sep = ',', quote = F)
  write.table(repB, paste0("baseline_cn_repB", i, "/nifti_files.csv"), row.names = F, col.names = F, sep = ',', quote = F)
}

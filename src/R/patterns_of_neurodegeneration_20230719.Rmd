---
title: "Patterns of Neurodegeneration 20230804"
author: "J. J. Lee"
date: "2023 Aug 4"
output:
  html_document:
...
getwd()
tib_covariates <- read_csv("baseline_cn/NumBases24/components/NMFCovariates_table_covariates_longitudinal.csv")
tib_covariates
```
...
split_components <- function(tib_in) {
  ...
  acqduration <- mdy(tib_in$AcqDuration)
  ...
  tib_out_$cohort <- relevel(factor(tib_out_$cohort), ref="CDR=0,amy-")
...
Invoke split_components.  
  Invoke split_components for subtable with Cohort=="CDR=0,amy-" and AcqDuration==0, 
...
age_cn <- soto_cn$age
sex_cn <- soto_cn$sex
apoe4_cn <- soto_cn$apoe4
cohort_cn <- soto_cn$cohort
subject_cn <- soto_cn$subject
acqduration_cn <- soto_cn$acqduration
Y_cn <- split_out_cn$Y
```
...
```{r dev=c("png", "tiff")}
b1 <- gam(list(
y0~s(age)+sex+apoe4+cohort, y1~s(age)+sex+apoe4+cohort, y2~s(age)+sex+apoe4+cohort, 
y3~s(age)+sex+apoe4+cohort, y4~s(age)+sex+apoe4+cohort, y5~s(age)+sex+apoe4+cohort, 
y6~s(age)+sex+apoe4+cohort, y7~s(age)+sex+apoe4+cohort, y8~s(age)+sex+apoe4+cohort, 
y9~s(age)+sex+apoe4+cohort, y10~s(age)+sex+apoe4+cohort, y11~s(age)+sex+apoe4+cohort, 
y12~s(age)+sex+apoe4+cohort, y13~s(age)+sex+apoe4+cohort, y14~s(age)+sex+apoe4+cohort, 
y15~s(age)+sex+apoe4+cohort, y16~s(age)+sex+apoe4+cohort, y17~s(age)+sex+apoe4+cohort, 
y18~s(age)+sex+apoe4+cohort, y19~s(age)+sex+apoe4+cohort, y20~s(age)+sex+apoe4+cohort, 
y21~s(age)+sex+apoe4+cohort, y22~s(age)+sex+apoe4+cohort, y23~s(age)+sex+apoe4+cohort), 
...
```{r dev=c("png", "tiff")}
b2 <- gam(list(
y0~s(age,by=interaction(sex))+sex+apoe4+cohort, y1~s(age,by=interaction(sex))+sex+apoe4+cohort, y2~s(age,by=interaction(sex))+sex+apoe4+cohort, 
y3~s(age,by=interaction(sex))+sex+apoe4+cohort, y4~s(age,by=interaction(sex))+sex+apoe4+cohort, y5~s(age,by=interaction(sex))+sex+apoe4+cohort, 
y6~s(age,by=interaction(sex))+sex+apoe4+cohort, y7~s(age,by=interaction(sex))+sex+apoe4+cohort, y8~s(age,by=interaction(sex))+sex+apoe4+cohort, 
y9~s(age,by=interaction(sex))+sex+apoe4+cohort, y10~s(age,by=interaction(sex))+sex+apoe4+cohort, y11~s(age,by=interaction(sex))+sex+apoe4+cohort, 
y12~s(age,by=interaction(sex))+sex+apoe4+cohort, y13~s(age,by=interaction(sex))+sex+apoe4+cohort, y14~s(age,by=interaction(sex))+sex+apoe4+cohort, 
y15~s(age,by=interaction(sex))+sex+apoe4+cohort, y16~s(age,by=interaction(sex))+sex+apoe4+cohort, y17~s(age,by=interaction(sex))+sex+apoe4+cohort, 
y18~s(age,by=interaction(sex))+sex+apoe4+cohort, y19~s(age,by=interaction(sex))+sex+apoe4+cohort, y20~s(age,by=interaction(sex))+sex+apoe4+cohort, 
y21~s(age,by=interaction(sex))+sex+apoe4+cohort, y22~s(age,by=interaction(sex))+sex+apoe4+cohort, y23~s(age,by=interaction(sex))+sex+apoe4+cohort), 
family=mvn(d=24), data=soto)
b2
summary(b2)
```
...
```{r dev=c("png", "tiff")}
b3 <- gam(list(
y0~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y1~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y2~s(age,by=interaction(apoE4))+sex+apoe4+cohort, 
y3~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y4~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y5~s(age,by=interaction(apoE4))+sex+apoe4+cohort, 
y6~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y7~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y8~s(age,by=interaction(apoE4))+sex+apoe4+cohort, 
y9~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y10~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y11~s(age,by=interaction(apoE4))+sex+apoe4+cohort, 
y12~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y13~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y14~s(age,by=interaction(apoE4))+sex+apoe4+cohort, 
y15~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y16~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y17~s(age,by=interaction(apoE4))+sex+apoe4+cohort, 
y18~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y19~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y20~s(age,by=interaction(apoE4))+sex+apoe4+cohort, 
y21~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y22~s(age,by=interaction(apoE4))+sex+apoe4+cohort, y23~s(age,by=interaction(apoE4))+sex+apoe4+cohort), 
family=mvn(d=24), data=soto)
b3
summary(b3)
```
...
```{r dev=c("png", "tiff")}
b4 <- gam(list(
y0~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y1~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y2~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, 
y3~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y4~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y5~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, 
y6~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y7~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y8~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, 
y9~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y10~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y11~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, 
y12~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y13~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y14~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, 
y15~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y16~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y17~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, 
y18~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y19~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y20~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, 
y21~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y22~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort, y23~s(age,by=interaction(sex,apoE4))+sex+apoe4+cohort), 
family=mvn(d=24), data=soto)
b4
summary(b4)
```
...
BIC(b4)
gam.check(b4)
save(b1, file="b4.Rdata")
saveRDS(b1, file="b4.Rds")
```
...
for (idx in 1:24) {
  ...
  b_i <- gam(y_i ~ s(age, k=20, by=interaction(sex))+sex, data=tib_y_i, method="REML")
  #summary(b_i)
  #AIC(b_i, k=2)
  #BIC(b_i)
  gam.check(b_i)
...
for (idx in 1:1) {
  ...
  b_i <- gamm4(y_i~s(age,by=interaction(sex))+sex, random=NULL, data=tib_y_i) 

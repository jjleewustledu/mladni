#####################################################################################
#  Analysis code used in "Patterns of Structural Covariance for Neurodegeneration"  #
#####################################################################################
...
# load data
setwd("/Volumes/PrecunealSSD/Singularity/ADNI/NMF_FDG/baseline4/NumBases28/components")
u <- read_csv("mladni_FDGDemographics_table_covariates.csv")

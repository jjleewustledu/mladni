classdef Neurosynth27 < handle
    %% line1
    %  line2
    %  
    %  Created 10-May-2023 13:54:25 by jjlee in repository /Users/jjlee/MATLAB-Drive/mladni/src/+mladni.
    ...
    methods
        ...
        function h = heatmap(this, mat, clbls, rlbls, opts)
            ...
            h.Title = "Pearson correlation of 27 Neurosynth topics and ADNI patterns";
        end
        ...
        function T = table_built_stats(this, varargin)
            %% test_neurodegeneration2.test_build_stats27; 
            %  hand-assembled by importing test_build_stats27.log

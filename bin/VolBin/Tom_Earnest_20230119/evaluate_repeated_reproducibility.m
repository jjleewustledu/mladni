...
PATH_ARIS_CODE = '/Users/earnestt1234/Documents/GitHub/aris_nmf_analyses';

addpath(PATH_ARIS_CODE);

% Parameters - I/O
inputdir = 'results/repeat_reproducibility';
outputdir = 'results/repeat_reproducibility_figures';
...
% save results
save(fullfile(outputdir, 'reproducibilityResults.mat'), 'repmeanInner','reapat_medianInner','repeat_ARI','sortedBasisNum');
